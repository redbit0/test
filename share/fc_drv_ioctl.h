...
//  
#define _io_init			_fc_iocode(0x0801, METHOD_BUFFERED, FILE_ANY_ACCESS)
#define _io_start_notify	_fc_iocode(0x0802, METHOD_NEITHER, FILE_ANY_ACCESS)
#define _io_stop_notify		_fc_iocode(0x0803, METHOD_NEITHER, FILE_ANY_ACCESS)
